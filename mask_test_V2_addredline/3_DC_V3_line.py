...
class my_dc(PlaceAndAutoRoute):
    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _default_child_transformations(self):
            ...
            trans["straight9"] = (0, -4300)
            trans["straight10"] = (3150, 20900)
            trans["straight11"] = (3150, -6300)
            trans["straight12"] = (3300, 20900)
            trans["straight13"] = (3300, -6300)
            trans["straight14"] = (6450, 20900)
            trans["straight15"] = (6450, -4300)
            trans["taper8"] = (150, 20900)
            trans["taper9"] = (150, -4300)
            trans["taper10"] = i3.HMirror(150) + i3.Translation((2850, 20900))
            trans["taper11"] = i3.HMirror(150) + i3.Translation((2850, -6300))
            trans["taper12"] = (3450, 20900)
            trans["taper13"] = (3450, -6300)
            trans["taper14"] = i3.HMirror(150) + i3.Translation((6150, 20900))
            trans["taper15"] = i3.HMirror(150) + i3.Translation((6150, -4300))
...
dc_10_layout.write_gdsii("3_DC_V3_line.gds")
