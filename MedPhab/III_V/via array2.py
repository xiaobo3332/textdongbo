...
class Release(i3.PCell):
    ...
    # Layer
    lay_release = i3.Layer(number=16, name="release")
        ...
        class Layout(i3.LayoutView):
            ...
            def _generate_elements(self, elems):
                ...
                for i in range (0,3,1):
                    ...
                    elems += i3.ARefY(n_o_periods_1d=7, period_1d=210, reference=release, origin=(3315.125+i*dx, 511.6))
                    ...
                    elems += i3.ARefY(n_o_periods_1d=15, period_1d=210, reference=release, origin=(3315.125+i*dx, 511.6+dy))
...
class PlaceMyComponents(i3.PCell):
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_elements(self, elems):
            ...
            elems += i3.SRef(reference=c1, transformation=i3.Translation((10700, 0)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((0, 10705)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((-10700, 0)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((-10700*2, 0)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((-10700, 10705)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((0, -10705)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((10700, -10705)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((-10700, -10705)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((-10700*2, -10705)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((0, -10705*2)))
            elems += i3.SRef(reference=c1, transformation=i3.Translation((-10700, -10705*2)))
...
PlaceMyComponents().Layout.view.write_gdsii("via2.gds")
