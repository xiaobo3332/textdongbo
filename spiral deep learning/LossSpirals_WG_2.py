...
class Spirals(PlaceAndAutoRoute):
    ...
    tt_port2 = i3.TraceTemplateProperty(doc="Wide trace template used for the contacts")
        ...
        def _default_child_transformations(self):
            ...
            for counter, child  in enumerate(self.Spiral_list):
                ...
                if self.tipo==1:
                    ...
                    d['InPort' + str(counter)] = i3.HMirror()+ i3.Translation(translation=(-self.chip_length/2.0-self.couplingWG_l, self.n*counter*sx))
                    d['OutPort' + str(counter)] = i3.Translation(translation=(self.chip_length/2.0+self.couplingWG_l, self.n*counter*sx))
                if self.tipo==2:
...
class Spirals_w(PlaceComponents):
    ...
    def _default_Spirals_w_list(self):
        ...
        for w, width in enumerate(self.width_vec):
            ...
            Spirals_w_list.append(Spirals(s_length_vec=self.s_length_vec, waveguide_template=wg_t, tipo=self.tipo, width=w+1, n=self.n,
...
#cell=Spirals_w(s_length_vec=[5800.0, 9000.0,12800.0,16100.0],width_vec=[3.6], tipo=1)
cell=Spirals_w(s_length_vec=[5000.0, 5000.0,5000.0,5000.0],width_vec=[3.2,3.4,3.6,3.8,4.0], tipo=2)

lv = cell.Layout()
lv.write_gdsii("Test 2.gds")
