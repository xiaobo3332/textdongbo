...
side1_r=16        #cladd reel obtenue au Ebeam
side1=side1_r / 2
w_core1_r=10     #core reel obtenue au Ebeam
w_core_w1=w_core1_r+side1
w_clad_w1=2*side1+w_core1_r

wg_coupler = WireWaveguideTemplate()
wg_coupler.Layout(core_width=w_core1_r, cladding_width=w_clad_w1)

#Grating 1
socket_lentgh_def=100
periode=2.3
line_widthe=0.2*periode
...
side2_r=16        #cladd reel obtenue au Ebeam
side2=side2_r / 2
w_core2_r=3.8     #core reel obtenue au Ebeam
w_core_w2=w_core2_r+side2
w_clad_w2=2*side2+w_core2_r

WG_T2FBMS = new_wg_template.Layout(core_width=w_core2_r, cladding_width=w_clad_w2,)
...
my_circuit_layout1.write_gdsii("grating.gds")
