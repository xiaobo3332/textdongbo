...
class v6(PlaceAndAutoRoute):
    ...
    def _default_wg_t1(self):
        ...
        wg_t1.Layout(core_width=20.0,
                     cladding_width=20.0 + 16.0,
    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _default_child_transformations(self):
            child_transformations = {
                                     ...
                                     "dummy1": (1450, -300+8300*2),
                                     "DWGup": (0, 21050),
                                     "DWGuptaper": (0, 21050),
                                     "DWGdown": (0, -4150+8300*2),
                                     "DWGdowntaper": (0, -4150+8300*2),
                                     "DWGuptaper2": i3.HMirror() + i3.Translation((3300, 21050)),
                                     "DWGdowntaper2": i3.HMirror() + i3.Translation((3300, -6150+8300*2)),
                                     "DWGup2": (3150, 21050),
                                     "DWGdown2": (3150, -6150+8300*2)
