		...
		def _default_child_transformations(self):
			...
			for counter, child in enumerate(self.MZI_22_22_list):
				...
				if self.tipo==2:
					...
					d['OutPort1_'+ str(counter)]= i3.Rotation(rotation=90.0)+i3.Translation(translation=(self.chip_length*0.5+counter*50+counter*4*self.R+a*self.R-100, self.couplingWG_l+self.R*a))
					d['InPort2_'+ str(counter)] = i3.HMirror()+i3.Translation(translation=(-self.chip_length*0.1, -5*self.R*counter+a*self.R))
					d['OutPort2_'+ str(counter)]= i3.Rotation(rotation=90.0)+i3.Translation(translation=(self.chip_length*0.5+counter*50+counter*4*self.R-100, self.couplingWG_l+self.R*a)) 
					
				d['InPortWG1'] = i3.HMirror()+i3.Translation(translation=(-self.chip_length*0.1, 1000.0))
				d['OutPortWG1']= i3.Rotation(rotation=90.0)+i3.Translation(translation=(self.chip_length*0.5-500, self.couplingWG_l+self.R*a))
				d['InPortWG2'] = i3.HMirror()+i3.Translation(translation=(-self.chip_length*0.1, -3400+670))
				d['OutPortWG2']= i3.Rotation(rotation=90.0)+i3.Translation(translation=(self.chip_length*0.5+2500, self.couplingWG_l+self.R*a))				
				d['InPortWG3'] = i3.HMirror()+i3.Translation(translation=(-self.chip_length*0.1, -6500))
				d['OutPortWG3']= i3.Rotation(rotation=90.0)+i3.Translation(translation=(self.chip_length*0.5+5600, self.couplingWG_l+self.R*a))				
			...
			for counter2, child in enumerate(self.MZI_12_22_list):
				...
				if self.tipo==2:
					...
					a=2.2
					b=500
					d['mzi_12_22_'+ str(counter+1+counter2)] = i3.Translation(translation=((counter+2+counter2)*850+1200+200+580+500,-(counter+1+counter2)*5*self.R-b))
					...
					d['OutPort1_'+ str(counter+1+counter2)]= i3.Rotation(rotation=90.0)+i3.Translation(translation=(self.chip_length*0.5+(counter+1+counter2)*50+a*self.R+(counter+1+counter2)*4*self.R+b, self.couplingWG_l+self.R*a))
					d['OutPort2_'+ str(counter+1+counter2)]= i3.Rotation(rotation=90.0)+i3.Translation(translation=(self.chip_length*0.5+(counter+1+counter2)*50+(counter+1+counter2)*4*self.R+b,self.couplingWG_l+self.R*a)) 
