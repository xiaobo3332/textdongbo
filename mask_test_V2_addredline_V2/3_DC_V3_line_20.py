...
class my_dc(PlaceAndAutoRoute):
    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _default_child_transformations(self):
            ...
            trans["taper11"] = i3.HMirror(150) + i3.Translation((2850, -6150+8300*2))
            trans["taper12"] = (3450, 21050)
            trans["taper13"] = (3450, -6150+8300*2)
            trans["taper14"] = i3.HMirror(150) + i3.Translation((6150, 21050))
            trans["taper15"] = i3.HMirror(150) + i3.Translation((6150, -4150+8300*2))
...
dc_10 = my_dc(width=20)
dc_10_layout = dc_10.Layout()
dc_10_layout.visualize(annotate=True)
dc_10_layout.write_gdsii("3_DC_V3_line_20.gds")
