...
class my_dc(PlaceAndAutoRoute):
    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _default_child_transformations(self):
            ...
            trans["straight8"] = (0, 20750)
            trans["straight9"] = (0, -4150)
            trans["straight10"] = (3150, 20750)
            trans["straight11"] = (3150, -6150)
            trans["straight12"] = (3300, 20750)
            trans["straight13"] = (3300, -6150)
            trans["straight14"] = (6450, 20750)
            trans["straight15"] = (6450, -4150)
            trans["taper8"] = (150, 20750)
            trans["taper9"] = (150, -4150)
            trans["taper10"] = i3.HMirror(150) + i3.Translation((2850, 20750))
            trans["taper11"] = i3.HMirror(150) + i3.Translation((2850, -6150))
            trans["taper12"] = (3450, 20750)
            trans["taper13"] = (3450, -6150)
            trans["taper14"] = i3.HMirror(150) + i3.Translation((6150, 20750))
...
dc_10_layout.write_gdsii("3_DC_V3_line_10.gds")
