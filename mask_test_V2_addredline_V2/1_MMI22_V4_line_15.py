    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _default_child_transformations(self):
            child_transformations = {
                                     ...
                                     "dummy1": (1300, -300+8300),
                                     "DWGup": (0, 20900),
                                     "DWGuptaper": (0, 20900),
                                     "DWGdown": (0, -4150+8300),
                                     "DWGdowntaper": (0, -4150+8300),
                                     "DWGuptaper2": i3.HMirror() + i3.Translation((3000, 20900)),
                                     "DWGdowntaper2": i3.HMirror() + i3.Translation((3000, -6150+8300)),
                                     "DWGup2": (2850, 20900),
                                     "DWGdown2": (2850, -6150+8300)
                                     }
...
pr_layout.write_gdsii("1_MMI22_V4_line_15.gds")
