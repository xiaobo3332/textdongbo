...
mmi1_21_taper = AutoTransitionPorts(contents = mmi1_21,
                                           port_labels = ['out'],
                                           trace_template = wg_sm2)
...
pr = PlaceAndAutoRoute( trace_template=wg_sm,
                        child_cells={"MMI1a": mmi1_12_taper,
                                    "MMI1b": mmi1_21_taper,
                                    "WGup": WG1,
                                    "WGdown": WG1,
                                    "WGup2": WG1,
...
pr2 = PlaceAndAutoRoute( trace_template=wg_sm2,
                        child_cells={"test": pr
                                   },
                       links=[
                              # ("MMI1a:out2", "WGuptaper2:in"),
                              # ("MMI1a:out1", "WGdowntaper2:in"),
                            ("test:MMI1b_out","test:MMI1a_in")
                              # ("WGuptaper:out", "MMI1b:in2"),
                              # ("WGdowntaper:out", "MMI1b:in1")
                       ]
                       )
...
layout2.write_gdsii("testmmiV4.gds")