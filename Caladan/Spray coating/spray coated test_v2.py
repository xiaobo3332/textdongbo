...
class Coupon2(i3.PCell):
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_elements(self, elems):
            ...
            elems += i3.SRef(reference=Release_horizontal(),
                             transformation=i3.Translation((20000-1125, 13440.0)))
            elems += i3.SRef(reference=Release_horizontal(),
                             transformation=i3.Translation((23500, 16480.0)))
            elems += i3.SRef(reference=Release_vertical(),
            ...
            elems += i3.SRef(reference=Release_horizontal(),
                             transformation=i3.Translation((34625, -10440.0+75)))
...
Coupon2().Layout.view.write_gdsii("Coupon2.gds")
