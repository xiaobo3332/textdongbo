...
class my_dc(PlaceAndAutoRoute):
    ...
    def _default_DC_list(self):
        ...
        for l, dl in enumerate(self.gap_inc_vec):
            ...
            cell = MMI2112(name='DC_gap_2_l_' + str(dl)+str(self.length), start_id=dl+self.length)
    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _default_child_transformations(self):
            ...
            trans["taper8"] = i3.HMirror(0) + i3.Translation((3000, 3500 + column))
            trans["taper9"] = i3.HMirror(0) + i3.Translation((3000, -3500 + column))
            ...
            trans["taper14"] = i3.HMirror(0) + i3.Translation((3000, 3500 + 2 * column))
            trans["taper15"] = i3.HMirror(0) + i3.Translation((3000, -3500 + 2 * column))
            ...
            trans["taper20"] = i3.HMirror(0) + i3.Translation((3000, 3500 + 3 * column))
            trans["taper21"] = i3.HMirror(0) + i3.Translation((3000, -3500 + 3 * column))
