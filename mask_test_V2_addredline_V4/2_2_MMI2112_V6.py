    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _generate_elements(self, elems):
                ...
                elems += i3.PolygonText(layer=i3.TECH.PPLAYER.WG.TEXT,
                                        text='Name={}_port_10'.format(self.cell.mmi1_21.get_default_view(i3.LayoutView).name),
...
class v6(PlaceAndAutoRoute):
    ...
    def _default_wg_t1(self):
        ...
        wg_t1.Layout(core_width=10.0,
                     cladding_width=10.0 + 16.0,
    ...
    class Layout(PlaceAndAutoRoute.Layout):
        ...
        def _default_child_transformations(self):
            child_transformations = {"MMI1b": (1300, 0),
                                     ...
                                     "DWGdown": (0, -4150),
                                     "DWGdowntaper": (0, -4150),
                                     "DWGuptaper2": i3.HMirror() + i3.Translation((3300, 4150)),
...
prr_layout.write_gdsii("2_1_MMI2112_V6.gds")
