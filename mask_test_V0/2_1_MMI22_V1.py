...
class v8(PlaceAndAutoRoute):
    ...
    def _default_WG2(self):
        WG2 = WireWaveguideTransitionLinear(name="WG2",
    ...
    def _default_wg_t1(self):
        wg_t1 = WireWaveguideTemplate(name="wg_t1")
    ...
    def _default_wg_sm(self):
        wg_sm = WireWaveguideTemplate(name="wg_sm")
...
pr_layout = pr.Layout(child_transformations={"1": (0, 0),
                                             ...
                                             "3": (6000, 0)})
# pr_layout.visualize()
pr_layout.write_gdsii("2_1_MMI22_V1.gds")
#
