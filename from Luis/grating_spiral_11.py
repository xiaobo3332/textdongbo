...
layout = wg_left.Layout(shape=[(field_Ebeamx/2+taper_length+socket_lentgh_def, field_Ebeamy), (field_Ebeamx/2+taper_length+overlap_wg+socket_lentgh_def, field_Ebeamy)])

wg_rigth = i3.Waveguide(name="my_wire_t4",
                 trace_template=WG_T2FBMS)
layout = wg_rigth.Layout(shape=[(-taper_length+field_Ebeamx/2+field_Ebeamx-overlap_wg+wg_length-socket_lentgh_def, field_Ebeamy), (-taper_length+field_Ebeamx/2+field_Ebeamx+wg_length-socket_lentgh_def, field_Ebeamy)])
...
my_circuit_layout1.write_gdsii("grating_spiral_11.gds")
